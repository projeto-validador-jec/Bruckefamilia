...
// ========================================================================
// ⚠️ ATENÇÃO: COLOQUE SUAS CREDENCIAIS DO ZEGOCLOUD AQUI
// ========================================================================
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          // ==========================================
          // BOTÃO EXISTENTE: CHAMADA DE VÍDEO
          // ==========================================
          IconButton(
...
// ========================================================================
// 🔐 CLASSE DE CRIPTOGRAFIA CORRIGIDA
// ========================================================================
...
// ========================================================================
// TELA DA CHAMADA DE ÁUDIO (ZEGOCLOUD)
// ========================================================================
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: ZegoUIKitPrebuiltCall(
        ...
        // oneOnOneVoiceCall() força a ser apenas ÁUDIO e já fecha automático
